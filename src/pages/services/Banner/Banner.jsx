    ...
    >
      ...
      <div className="w-full md:w-1/2" data-aos="fade-right">
        ...
        <p className="text-gray-300 text-lg md:text-xl mt-4">
          If you're looking for a clinic in Dakshin Natai that offers
          compassionate alternative medicine, consider clinics that specialize
          in holistic therapies, natural medicine, or integrative healthcare.
        </p>
      </div>
      </div>
